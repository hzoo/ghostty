...
extension TerminalWindow {
    private static let closeTabsOnRightMenuItemIdentifier = NSUserInterfaceItemIdentifier(ProductBrand.namespaced("closeTabsOnTheRightMenuItem"))
    private static let changeTitleMenuItemIdentifier = NSUserInterfaceItemIdentifier(ProductBrand.namespaced("changeTitleMenuItem"))
    private static let tabColorSeparatorIdentifier = NSUserInterfaceItemIdentifier(ProductBrand.namespaced("tabColorSeparator"))

    private static let tabColorPaletteIdentifier = NSUserInterfaceItemIdentifier(ProductBrand.namespaced("tabColorPalette"))
